...
```
	Fabricator = {
		...
		inventory = {
			{ name = 'large_fabricator', price = 50000, count = 3},
			{ name = 'small_fabricator', price = 25000, count = 3 },
			{ name = 'fabricator_battery', price = 1000, count = 3 },
		},
		locations = {
...
Join our Discord: https://discord.gg/mTzwCnNcaX
